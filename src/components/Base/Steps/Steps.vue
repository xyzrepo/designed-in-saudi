                ...
                <a v-else :href="step.href" class="group flex items-center">
                    <span
                        ...
                        <span
                            ...
                            <span
                                class="text-gray-500 group-hover:text-gray-900">{{ step.id }}</span>
                        </span>
                        <span
                            class="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">{{ step.name }}</span>
                    </span>
                </a>
...
// const steps = [
//   { id: '01', name: 'Create an account', href: '#', status: 'complete' },
//   { id: '02', name: 'Confirm your email', href: '#', status: 'current' },
//   { id: '03', name: 'Complete your profile', href: '#', status: 'upcoming' },
//   { id: '04', name: 'Create an idea', href: '#', status: 'upcoming' },
//   { id: '05', name: 'Submit your idea', href: '#', status: 'upcoming' },
// ]
defineProps({
    steps: {
        type: Array,
