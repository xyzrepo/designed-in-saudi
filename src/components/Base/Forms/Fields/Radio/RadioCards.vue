...
<template>
    <RadioGroup v-model="selectedOption" class="my-6">
        <RadioGroupLabel class="pt-8 text-2xl font-medium text-gray-900">{{
            label
        }}</RadioGroupLabel>

        <div
            v-if="selectedOption"
            class="mt-1 flex pt-4 text-xl text-gray-900 sm:col-span-2 sm:mt-0">
        ...
        <div
            v-show="selectedOption === null"
            :class="`mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-${
                grid ? '2' : '1'
            } lg:grid-cols-${grid ? '3' : '1'} sm:gap-x-4`">
            <RadioGroupOption
        ...
        default: () => [
            {
                ...
                name: 'Yes',
                description: 'YASSSSS!!!',
                meta: 'This means you like it'
            },
            {
                id: 2,
                name: 'No',
                description: 'Nope. Nyet. Nada.',
                meta: 'This means you hate it'
            }
        ]
    }
})
