...
const en = {
    ...
    whatWeDo: {
        title: 'What we do',
        description:
            'We enable individuals to submit product ideas through our invention platform and we turn their ideas into quality products by utilizing our partner network of experts, sponsors, and manufacturers.'
    },
    whyItMatters: {
    ...
    valueProposition: {
        ...
        items: [
            ...
            },
            {
                ...
                name: 'Passive Income',
                description:
                    'Creators get to build a product portfolio, receive community recognition, and generate passive income from their manufactured product ideas'
            },
            {
            ...
            },
            {
                ...
                description:
                    'Sponsors can join our partner network and get access to investment opportunities with low capital requirements and gain short-term profit from the created opportunities'
            }
        ]
    },
    community: {
    ...
    platform: {
        ...
        subtitle:
            'An ecosystem that provides complete services to transfer ideas to a product',
        items: [
            {
    ...
    market: {
        ...
        description:
            'The market of e-commerce in Saudi Arabia has been going through steady growth as more shops are moving towards e-commerce as a sale channel',
        items: [
            {
                id: 1,
                stat: '93%',
                description:
                    'Internet users in Saudi Arabia are 93% of the total population.'
            },
            {
                id: 2,
                stat: '38B+',
                description:
                    '38+ Billion Saudi Riyal is spent yearly on online shopping.'
            },
            {
                id: 3,
                stat: '21M+',
                description:
                    'The total number of online shoppers in Saudi Arabia is 21.43 millions'
            },
            {
                id: 4,
                stat: '70%',
                description:
                    'The number of online stores has increased 70% in the past 4 years.'
            }
        ]
    },
    contact: {
...
const ar = {
    intro: {
        ...
        description:
            'نحن مسرعة متخصصة في التصميم لغرض التصنيع (DFM) وهي عملية تصميم أجزاء أو مكونات أو منتجات لسهولة التصنيع بهدف نهائي يتمثل في صنع منتج أفضل بتكلفة أقل.'
    },
    whatWeDo: {
        title: 'ماذا نفعل',
        description:
            'نحن نمكن أفراد المجتمع من تقديم أفكار مبتكرة عن طريق منصة الاختراع الخاصة بنا ونحول أفكارهم إلى منتجات عالية الجودة من خلال استخدام شبكة شركائنا من الخبراء والرعاة والمصنعين.'
    },
    whyItMatters: {
        ...
        items: [
            {
                ...
                name: 'منصة إبتكار',
                description:
                    'منصة على شبكة الإنترنت للمخترعين لتقديم أفكار المنتجات ومراقبة التقدم المحرز.'
            },
            {
                icon: ClipboardListIcon,
                name: 'معايير تصميم',
                description:
                    'رحلة تصميم وتصنيع صارمة ومميزة تضمن ظهور الأفكار كمنتجات عالية الجودة.'
            },
            {
                icon: ClipboardListIcon,
                name: 'معايير تصميم',
        ...
        items: [
            {
                name: 'المخترعون',
                description:
                    'فرد أو جماعي، أو عشاق DIY، أو مصممين محترفين لديهم أفكار منتجات.',
                icon: LightBulbIcon
            },
            {
                name: 'شبكة الشركاء',
                description:
                    'اتصالنا من المصنعين وتجار التجزئة ومقدمي الخدمات اللوجستية ... إلخ',
                icon: UserGroupIcon
            },
            {
                name: 'الرعاة',
                description:
                    'الأفراد الذين يبحثون عن فرص استثمارية قصيرة الأجل ذات مخاطر منخفضة',
                icon: UsersIcon
            },
            {
                name: 'العملاء',
                description:
                    'المستهلكون النهائيون الذين يشترون المنتجات النهائية من خلال قنوات التجارة الإلكترونية الخاصة بنا',
                icon: HeartIcon
            }
        ]
    },
    platform: {
        ...
        subtitle:
            'نظام بيئي يوفر خدمات متكاملة لتحويل الأفكار إلى منتجات عالية الجودة',
        items: [
            {
                name: 'البحث',
                description:
                    'المرحلة الأولى من الفكرة حيث يتم تحويل جدوى التصميم إلى منتج.',
                icon: InboxIcon
            },
            {
                name: 'التصميم',
                description:
                    'المرحلة التي يمر فيها التصميم بسلسلة من فحوصات الجودة والمواصفات النهائية المحددة',
                icon: UsersIcon
            },
            {
                name: 'التصنيع',
                description:
                    'حيث تصبح الفكرة منتجا عالي الجودة لعملائنا الكرام.',
                icon: TrashIcon
            },
            {
                name: 'التسويق',
            ...
            },
            {
                ...
                description:
                    'بيع المنتج من خلال قنواتنا الإلكترونية أو شركائنا في البيع.',
                icon: ReplyIcon
            },
            {
                name: 'الخدمات اللوجستية',
                description:
                    'شحن المنتج إلى المنتج الإلكتروني إلى متاجرنا من هناك إلى العميل النهائي.',
    ...
    market: {
        ...
        subtitle: 'إحصائيات',
        description:
            'يمر سوق التجارة الإلكترونية في المملكة العربية السعودية بنمو مطرد حيث تتجه المزيد من المتاجر نحو التجارة الإلكترونية كقناة بيع',
        items: [
            {
                id: 1,
                stat: '93%',
                description:
                    'يشكل مستخدمو الإنترنت في المملكة العربية السعودية 93٪ من إجمالي السكان.'
            },
            {
                id: 2,
                stat: '38B+',
                description:
                    'يتم إنفاق أكثر من 38 مليار ريال سعودي سنويا على التسوق عبر الإنترنت.'
            },
            {
                id: 3,
                stat: '21M+',
                description:
                    'يبلغ إجمالي عدد المتسوقين عبر الإنترنت في المملكة العربية السعودية 21.43 مليون'
            },
            {
                id: 4,
                stat: '70%',
                description:
                    'زاد عدد المتاجر عبر الإنترنت بنسبة 70٪ في السنوات الأربع الماضية.'
            }
        ]
    },
    contact: {
        ...
        description:
            'نحب أن نسمع منك. اتصل بنا أو راسلنا عبر البريد الإلكتروني وسنقوم بالرد عليك في أقرب وقت ممكن!'
    }
}
export { en, ar }
