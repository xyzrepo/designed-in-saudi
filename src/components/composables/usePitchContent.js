...
const ar = {
  intro: {
    ...
    subtitle: "We turn ideas into quality products",
    description:
      "نحن مسرع تصميم المنتجات المتخصص في تصميم التصنيع (DFM) وهي عملية تصميم أجزاء أو مكونات أو منتجات لسهولة التصنيع بهدف نهائي يتمثل في صنع منتج أفضل بتكلفة أقل.",
  },
  whatWeDo: {
    title: 'ماذا نفعل',
    description: 'We enable individuals to submit product ideas through our invention platform and we turn their ideas into quality products by utilizing our partner network of experts, sponsors, and manufacturers.'
...
export default (dir) => {
    if (dir === 'rtl') return readonly(ar)
    else return readonly(en)
}