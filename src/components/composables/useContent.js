    ...
    oldplatform: {
        ...
        items: [
            ...
            },
            {
                name: 'Manufacturing',
                description:
                    'Where the idea becomes a quality product for our valuable consumers.',
                icon: TrashIcon
            },
            {
                name: 'Marketing',
...
export const invention = reactive({ welcome: ref({}) })
export default en
