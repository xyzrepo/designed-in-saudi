...
export const socials = [
    ...
    {
        name: 'AngelList',
        href: 'https://angel.co/company/designedsaudi',
        icon: defineComponent({
            render: () =>
    ...
    {
        name: 'YouTube',
        href: 'https://www.youtube.com/channel/UCLBapEjPKlouA_j6b0XFi5w/about',
        icon: defineComponent({
            render: () =>
    ...
    {
        name: 'TikTok',
        href: 'https://vm.tiktok.com/ZSdFry11Y/',
        icon: defineComponent({
            render: () =>
                h('svg', { fill: 'currentColor', viewBox: '0 0 448 512' }, [
                    h('path', {
    ...
    {
        name: 'Snapchat',
        href: 'https://www.snapchat.com/add/DesignedSaudi',
        icon: defineComponent({
            render: () =>
                h('svg', { fill: 'currentColor', viewBox: '0 0 448 512' }, [
                    h('path', {
    ...
    {
        name: 'Linkedin',
        href: 'https://www.linkedin.com/company/designedsaudi',
        icon: defineComponent({
            render: () =>
                h('svg', { fill: 'currentColor', viewBox: '0 0 448 512' }, [
                    h('path', {
    ...
    {
        name: 'Instagram',
        href: 'https://instagram.com/DesignedSaudi',
        icon: defineComponent({
            render: () =>
                h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                    h('path', {
    ...
    {
        name: 'Twitter',
        href: 'https://twitter.com/DesignedSaudi',
        icon: defineComponent({
            render: () =>
                h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                    h('path', {
