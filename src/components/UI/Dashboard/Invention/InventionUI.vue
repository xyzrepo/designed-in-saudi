<template>
    <InventionWizard :steps="steps">
        ...
        <InventionStep
            ...
            subtitle="Tell us a little bit about your invention.">
            <InventionForm />
        </InventionStep>
        ...
        <InventionStep
            :step="2"
            title="Category"
            :action="{ name: `Continue`, fn: nextStep }">
            <RadioCards
        ...
        <InventionStep
            ...
            subtitle="Please choose the privacy level you require">
            <RadioCards
                v-model="formData.privacy_level"
                label="Privacy"
...
import { categories,
    formData,
    nextStep,
    privacyOptions } from '@composables/useInvention'
const steps = ref([
    { name: 'Step 1' },
    { name: 'Step 2' },
    { name: 'Step 3' },
