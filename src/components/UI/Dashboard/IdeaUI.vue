<template>
  <form class="space-y-8 divide-y divide-gray-200">
    <div class="space-y-8 divide-y divide-gray-200">
      <div>
        <div>
          <h3 class="text-lg leading-6 font-medium text-gray-900">{{ item.title || 'Untitled Idea' }}</h3>
          <p class="mt-1 text-sm text-gray-500">{{ item.subtitle || 'This information will be displayed publicly so be careful what you share.'}}</p>
        </div>
       ...
       <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
           <div class="sm:col-span-4">
            ...
            <div class="mt-1 flex rounded-md shadow-sm">
              <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm"> DesignedinSaudi.com/ </span>
          ...
          <div class="sm:col-span-6">
            ...
            <p class="mt-2 text-sm text-gray-500">Write a few sentences about your idea.</p>
          </div>
