<template>
    <Section v-if="alt" class="bg-gradient-to-r from-purple-800 to-indigo-700">
        <div
            class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <h2
                class="text-base font-semibold uppercase tracking-wider text-white">
                {{ title || 'Deploy faster' }}
            </h2>
            <p
                class="mt-2 text-3xl font-extrabold tracking-tight text-purple-200 sm:text-4xl">
                    ...
                    <div
                        ...
                        <div class="flow-root rounded-lg px-6 pb-8">
                            <div class="-mt-6">
                                <div>
                                    <span
                                        class="inline-flex items-center justify-center rounded-md bg-white bg-opacity-10 p-3 shadow-lg">
                                        <component
                                            :is="feature.icon"
                                ...
                                <h3
                                    class="mt-8 text-lg font-medium tracking-tight text-white">
                                    {{ feature.name }}
                                </h3>
                                <p class="mt-5 text-base text-purple-200">
                                    {{ feature.description }}
                                </p>
                            </div>
                        </div>
