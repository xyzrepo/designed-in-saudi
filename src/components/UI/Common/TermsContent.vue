<template>
    ...
    <p>Last updated: April 20, 2022</p>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Designed in Saudi LLC, Khobar, Saudi Arabia.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Designed in Saudi, accessible from <a
                    href="https://designedinsaudi.com" rel="external nofollow noopener"
                    target="_blank">https://designedinsaudi.com</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p>By email: team@designedinsaudi.com</p>
        </li>
        <li>
            <p>By visiting this page on our website: <a href="https://designedinsaudi.com/contact"
                    rel="external nofollow noopener" target="_blank">https://designedinsaudi.com/contact</a></p>
        </li>
    </ul>
</template>