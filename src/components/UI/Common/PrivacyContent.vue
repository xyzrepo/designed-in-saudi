    ...
    <ul>
        ...
        <li>
            <p>
                ...
                in this Agreement) refers to Designed in Saudi LLC, Khobar,
                Saudi Arabia.
            </p>
        </li>
        <li>
        ...
        <li>
            <p>
                <strong>Website</strong> refers to Designed in Saudi, accessible
                from
                <a href="https://designedinsaudi.com" rel="external nofollow noopener"
                    target="_blank">https://designedinsaudi.com</a>
            </p>
        </li>
        <li>
            <p>
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                <a href="https://designedinsaudi.com/contact" rel="external nofollow noopener"
                    target="_blank">https://designedinsaudi.com/contact</a>
            </p>
        </li>
    </ul>
</template>
