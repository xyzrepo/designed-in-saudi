...
<template>
    <div>
        ...
        <div class="mt-4 flex">
            <a
                href="#"
                class="text-sm font-medium text-indigo-600 hover:text-indigo-500">Or start from an empty project<span aria-hidden="true">
                    &rarr;</span></a>
        </div>
    </div>
</template>
...
import { CalendarIcon,
    ...
    TableIcon,
    ViewBoardsIcon,
    ViewListIcon } from '@heroicons/vue/outline'
