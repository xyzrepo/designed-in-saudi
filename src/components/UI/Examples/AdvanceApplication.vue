                ...
                <div class="flex items-center space-x-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-500">
                            Applied for
                            <a href="#" class="text-gray-900">Front End Developer</a>
                            on
                    ...
                    <section aria-labelledby="applicant-information-title">
                        <div class="bg-white shadow sm:rounded-lg">
                            ...
                            <div>
                                <a
                                    href="#"
                                    class="block bg-gray-50 px-4 py-4 text-center text-sm font-medium text-gray-500 hover:text-gray-700 sm:rounded-b-lg">Read full application</a>
                            </div>
                        </div>
                    </section>
...
import { ArrowNarrowLeftIcon,
    ...
    SearchIcon,
    ThumbUpIcon,
    UserIcon } from '@heroicons/vue/solid'
