<template>
    <section
        class="bg-gray-50 pt-20"
        style="
            background-image: url('/src/assets/images/elements/pattern-light1.svg');
            background-position: center;
        ">
        <div class="container mx-auto px-4">
            <div class="mx-auto mb-16 max-w-4xl text-center">
                <h3
                    class="text-darkgray-900 mb-4 text-4xl font-bold leading-tight tracking-tighter md:text-5xl">
            ...
            <div class="-mx-4 flex flex-wrap pb-16">
                <div class="mb-10 w-full px-4 md:mb-0 md:w-full">
                    <div class="mx-auto max-w-xs text-center">
                        <div
                            class="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-full bg-violet-500">
                            <svg
                        ...
                        <h3
                            class="mb-2 text-2xl font-bold leading-9 text-gray-800 rtl:hidden md:text-3xl">
                            Email
                        </h3>
                        <h3
                            class="mb-2 text-2xl font-bold leading-9 text-gray-800 ltr:hidden md:text-3xl">
                            البريد الإلكتروني
                        </h3>
                        <a
                            class="text-xl font-medium text-gray-500 hover:text-gray-600"
                            href="mailto:#">info@designedinsaudi.com</a>
                    </div>
                </div>
              ...
              <div class="max-w-xs mx-auto text-center">
                ...
                <h3 class="mb-2 text-2xl md:text-3xl leading-9 text-gray-800 font-bold">Phone</h3>
                <p class="text-xl text-gray-500 font-medium">+7-843-672-431</p>
              </div>
            </div>
            <div class="w-full md:w-1/3 px-4">
              <div class="max-w-xs mx-auto text-center">
                ...
                <h3 class="mb-3 text-2xl md:text-3xl font-bold leading-9 text-gray-900">Socials</h3>
                <a v-for="(social, index) in socials" :key="index"
                class="inline-block mr-6 text-violet-500 hover:text-violet-600" :href="social.href">
