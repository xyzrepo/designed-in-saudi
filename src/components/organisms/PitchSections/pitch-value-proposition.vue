...
<section class="py-24 bg-gray-900" style="background-image: url('/flex-ui-assets/elements/pattern-dark2.svg'); background-position: center;">
        <div class="container px-4 mx-auto">
          <div class="xl:max-w-4xl mb-12 mx-auto text-center">
            ...
            <h1 class="mb-4 text-3xl md:text-4xl leading-tight text-white font-bold tracking-tighter">The Value Proposition</h1>
            <p class="text-lg md:text-xl text-gray-400 font-medium">A Product Invention Platform</p>
          </div>
          <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-1/3 px-4 lg:pt-6 mb-8 lg:mb-0">
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                <div class="inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-gray-900 bg-violet-500 rounded-lg">
                ...
                <h3 class="mb-4 text-xl md:text-2xl leading-tight text-white font-bold">Innovative Platform</h3>
                <p class="text-gray-400 font-medium">A digital platform for creators to submit product ideas and monitor progress on timely manner</p>
              </div>
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                <div class="inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-gray-900 bg-violet-500 rounded-lg">
                ...
                <h3 class="mb-4 text-xl md:text-2xl leading-tight text-white font-bold">Passive Incomes</h3>
                <p class="text-gray-400 font-medium">Creators get to build a product portfolio, receive community recognition, and generate passive income from their manufactured product ideas</p>
              </div>
            </div>
            ...
            <div class="w-full lg:w-1/3 lg:pt-6 px-4">
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                ...
                <h3 class="mb-4 text-xl md:text-2xl leading-tight text-white font-bold">Design Guidelines</h3>
                <p class="text-gray-400 font-medium">A rigorous and disciplined design-for-manufacturing journey that ensures ideas come out as quality products</p>
              </div>
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                <div class="inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-gray-900 bg-violet-500 rounded-lg">
                  <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 class="mb-4 text-xl md:text-2xl leading-tight text-white font-bold">Investment Opportunities</h3>
                <p class="text-gray-400 font-medium">Sponsors can join our partner network and get access to investment opportunities with low capital requirements and gain short-term profit from the created opportunities</p>
              </div>
            </div>
          </div>
        </div>
