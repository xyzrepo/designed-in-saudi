<template>
<section class="py-24 overflow-hidden bg-white" style="background-image: url('flex-ui-assets/elements/pattern-white.svg'); background-position: center;">
          ...
          <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full md:w-1/2 px-4">
              <div class="relative max-w-max mx-auto">
                ...
                <img class="absolute bottom-0 left-0 -mb-6 lg:-mb-10-ml-6 lg:-ml-12 w-20 lg:w-auto" src="flex-ui-assets/elements/dots3-yellow.svg" alt="">
                <img class="relative" src="flex-ui-assets/elements/cta/photo-laptop-ph.png" alt="">
              </div>
            </div>
          </div>
        </div>
