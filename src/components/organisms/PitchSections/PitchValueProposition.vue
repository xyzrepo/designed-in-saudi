          ...
          <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-1/3 px-4 lg:pt-6 mb-8 lg:mb-0">
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                <div class="inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-gray-100 bg-violet-500 rounded-lg">
              ...
              <div class="p-8 text-center hover:bg-gray-700 rounded-md hover:shadow-xl transition duration-200">
                ...
                <h3 class="mb-4 text-xl md:text-2xl leading-tight text-white font-bold">Passive Income</h3>
