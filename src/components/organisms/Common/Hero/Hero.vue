    ...
    <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
      ...
      <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
        <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
          ...
          <span class="block text-2xl sm:text-4xl text-indigo-200">{{subtitle}}</span>
        </h1>
        <p class="mt-6 max-w-lg mx-auto text-center text-2xl font-light text-indigo-200 sm:max-w-3xl">{{description}}</p>
...
defineProps({
  title: {
    type: String,
    default: 'The Invention Hub'
  },
  subtitle: {
    type: String,
    default: 'Where ideas come to life'
  },
  description: {
    type: String,
