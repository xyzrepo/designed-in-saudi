...
<template>
  <div class="bg-white">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
      <div>
        <h2 class="text-base font-semibold text-indigo-600 uppercase tracking-wide">{{ title || 'Everything you need' }}</h2>
        <p class="mt-2 text-3xl font-extrabold text-gray-900">{{ subtitle || 'All-in-one platform' }}</p>
