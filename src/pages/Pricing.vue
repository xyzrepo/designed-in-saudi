...
<template>
    ...
    <!-- Logo cloud on brand -->
    <ShowcaseLogos :logos="logos" title="The world's most innovative companies use Workflow"/>
...
import PricingWithFeatures from '../components/PricingWithFeatures.vue'
import ShowcaseLogos from '@/components/ShowcaseLogos.vue'
