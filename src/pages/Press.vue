<template>
  <div class="bg-white pt-0 pb-20 px-4 sm:px-6 lg:pt-10 lg:pb-28 lg:px-8">
    <div class="relative max-w-xl mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
      <!-- <div> -->
        <div class="gradient text-7xl tracking-tight font-extrabold text-gray-900 sm:text-9xl">Press</div>
