<template>
    <div class="bg-white px-4 pt-0 pb-20 sm:px-6 lg:px-8 lg:pt-10 lg:pb-28">
        <div
            class="relative mx-auto max-w-xl divide-y-2 divide-gray-200 lg:max-w-7xl">
            <!-- <div> -->
            <div
                class="gradient text-7xl font-extrabold tracking-tight text-gray-900 sm:text-9xl">
                Press
            </div>
